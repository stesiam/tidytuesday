...
plot = winners %>%
  ...
  theme_classic() +
  theme(
    plot.title = element_markdown(family = "jost", size = 15),
    plot.subtitle = element_markdown(family = "jost"),
    ...
    plot.margin = margin(t = 5, b = 5, r = 30, l =3),axis.text = element_text(family = "uc")
)
